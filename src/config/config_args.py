...
parser.add_argument("--save_dir", default=os.path.join(os.path.abspath(up(up(__file__))), 'implementation'), type=str) #Modification so it can be debugged in IDE
...
parser.add_argument("--checkpoint_sam", default=os.path.join(os.path.abspath(up(up(__file__))), 'checkpoint_sam/sam_vit_b_01ec64.pth'), type=str, 
                    help='path of pretrained SAM') #Modification to enable debugging in IDE.
...
parser.add_argument("--save_test_dir", default=os.path.abspath(up(up(__file__))))
